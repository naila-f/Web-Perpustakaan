          ...
          <div class="card-body">
            <form action="{{ route('simpan-pegawai') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nip" name="nip" class="form-control @error ('nip') is-invalid @enderror" placeholder="nip">
                    @error('nip')
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="jabatan" name="jabatan" class="form-control @error ('jabatan') is-invalid @enderror" placeholder="jabatan">
                    @error('jabatan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
