  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class=" card card-info card-outline">
          ...
          <h3> Tambah Data Majalah </h3>
          </div>
          <div class="card-body">
            <form action="{{ route('simpan-majalah') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="inputid_majalah" class="col-sm-2 col-form-label">Id Majalah</label>
                    <input type="id" id="id_majalah" name="id_majalah" class="form-control @error ('id_majalah') is-invalid @enderror" placeholder="id_majalah">
                    @error('id_majalah')
