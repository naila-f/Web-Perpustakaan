          ...
          <div class="card-body">
            <form action="{{ route('simpan-berita') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="author" name="author" class="form-control @error ('author') is-invalid @enderror" placeholder="Author">
                    @error('author')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="resume" name="resume" class="form-control @error ('resume') is-invalid @enderror" placeholder="Ringkasan Berita">
                    @error('resume')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="publised_at" name="publised_at" class="form-control @error ('publised_at') is-invalid @enderror" placeholder="Publish">
                    @error('publised_at')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
