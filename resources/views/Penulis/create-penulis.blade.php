  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class=" card card-info card-outline">
          ...
          <div class="card-body">
            <form action="{{ route('simpan-penulis') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="inputid_penulis" class="col-sm-2 col-form-label">Id Penulis</label>
                    <input type="id" id="id_penulis" name="id_penulis" class="form-control @error ('id_penulis') is-invalid @enderror" placeholder="id_penulis">
                    @error('id_penulis')
                ...
                <div class="form-group">
                    ...
                    <input type="integer" id="no_hp" name="no_hp" class="form-control @error ('no_hp') is-invalid @enderror" placeholder="no_hp">
                    @error('no_hp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
